...
COMMENT ON COLUMN vendors.makanjom_restaurant_id IS
  'UUID of the corresponding restaurants row in Makanjom. When set, the Odabear store page shows a "Discover on Makanjom" back-link.';
